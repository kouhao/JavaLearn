...
public class NioEchoServer {
	...
	public static void main(String args[]) throws Exception {
		...
		serverSocketChannel.socket().bind(new InetSocketAddress(9910));
		// 设置非阻塞
		...
		while (true) {
			...
			// 获取 I/O 操作就绪的 SelectionKey, 通过 SelectionKey 可以知道哪些 Channel 的哪类 I/O
			// 操作已经就绪.
			...
			while (keyIterator.hasNext()) {
				...
				if (key.isAcceptable()) {
					...
					// 注意, 这里我们如果没有设置 OP_READ 的话, 即 interest set 仍然是 OP_CONNECT
					// 的话, 那么 select 方法会一直直接返回.
